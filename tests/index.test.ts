...
describe('main', () => {
  ...
  it('handles subscription events and schedules unsubscribe', () => {
    ...
    expect(secondsSinceConsensus).toHaveBeenCalledWith(1000n, expect.any(BigInt))
    expect(logSpy).toHaveBeenCalledWith('consensus_timestamp was about 5 seconds ago')
